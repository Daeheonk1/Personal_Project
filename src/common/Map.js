...
export default function Map(props) {
        ...
        service.getDetails(request, (place, status) => {
            if (
                ...
                window.google.maps.event.addListener(marker, "click", () => {
                    ...
                    const openHourIdElement = document.createElement("p");

                    openHourIdElement.textContent = place.opening_hours.weekday_text;
                    content.appendChild(openHourIdElement);
    ...
    // }
    return (
        <div style={{ width: "600px", height: "500px", marginRight: "10px" }} ref={mapRef} />
    )
}
